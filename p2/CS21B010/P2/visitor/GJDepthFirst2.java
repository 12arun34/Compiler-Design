...
public class GJDepthFirst2<R,A> implements GJVisitor<R,A> {
    ...
    * f2 -> <EOF>
    */
   public R visit(Goal n, A argu) {                         // NO CHANGE REQUIRED
      R _ret=null;
    ...
    * f16 -> "}"
    */
   public R visit(MainClass n, A argu) {                                 // NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
    ...
    */
   public R visit(TypeDeclaration n, A argu) {                         // NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      return _ret;
   }
    ...
    * f5 -> ")"
    * f6 -> "{"
    * f7 -> ( VarDeclaration() )*                               // two type var declare assumed ??????????????????
    * f8 -> ( Statement() )*
    * f9 -> "return"
    * f10 -> Expression()
    * f11 -> ";"
    ...
    */
   public R visit(FormalParameterList n, A argu) {          // 	NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      return _ret;
    ...
    * f1 -> Identifier()
    */
   public R visit(FormalParameter n, A argu) {              // 	NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      return _ret;
    ...
    * f1 -> FormalParameter()
    */
   public R visit(FormalParameterRest n, A argu) {             // 	NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      return _ret;
    ...
    * f2 -> "]"
    */
   public R visit(ArrayType n, A argu) {                 // ASSUMING ARRAY OF INT ONLY ?????????????
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
    ...
    *       | PrintStatement()
    */
   public R visit(Statement n, A argu) {                      // NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      return _ret;
   }
    ...
    * f2 -> "}"
    */
   public R visit(Block n, A argu) {                         // NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
   ...
   public R visit(AssignmentStatement n, A argu) {
      ...
      else if( my_map1.containsKey(cur_id1)){lhs_type = var_map1.get(cur_id1);}    // class object type                              
      else if(my_map2.get(cur_class1).containsKey(cur_id1)){lhs_type = var_map1.get(cur_class1).get(cur_id1);}  // global variable in same class
      else exitNow(2);
    ...
    *       | IfthenStatement()
    */
   public R visit(IfStatement n, A argu) {                 // NO CHANGE REQUIRED
      R _ret=null;
      n.f0.accept(this, argu);
      return _ret;
   }
   ...
   public R visit(MessageSend n, A argu) {
      ...
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
      cur_exr_type = my_map1.get(node_class).(cur_id1).getfirst();
      n.f3.accept(this, argu);
      n.f4.accept(this, argu);
      n.f5.accept(this, argu);
      return _ret;
    ...
    * f1 -> Expression()
    */
   public R visit(NotExpression n, A argu) {                  // no change in current expression type
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      if(!cur_exp_type.equals("boolean"))
    ...
    * f2 -> ")"
    */
   public R visit(BracketExpression n, A argu) {         // no change in current expression type
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      n.f2.accept(this, argu);
    ...
    * f1 -> ( IdentifierRest() )*
    */
   public R visit(IdentifierList n, A argu) {                      // where use of identifierlist
      R _ret=null;
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      return _ret;
